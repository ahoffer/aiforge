#!/usr/bin/env bash
# Launches OpenCode AI coding assistant against local Ollama with MCP tool servers.
...
# Generate config with Ollama provider and MCP servers.
...
exec opencode -m "ollama/${OPENCODE_MODEL}" "$@"
